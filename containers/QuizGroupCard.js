    ...
    return (
      <div>
        {element.answers.map((answer, index) =>
          <div
            key={index} style={(this.state.voteFlag && this.state.clickedAnswer === answer) ? {border: '#ddd', color: 'black', backgroundColor: 'lightGrey', borderRadius: 5,
            borderStyle: 'solid', padding: 10, borderWidth: 1, margin: 5} : {border: '#ddd', color: 'black', backgroundColor: 'white', borderRadius: 5,
